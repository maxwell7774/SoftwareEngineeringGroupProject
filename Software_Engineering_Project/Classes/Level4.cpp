...
bool Level4::init()
{
    ...
    key = Sprite::create("res/PNG/Items/keyYellow.png");
    ...
    listener->onKeyPressed = CC_CALLBACK_2(Level4::onKeyPressed, this);
    listener->onKeyReleased = CC_CALLBACK_2(Level4::onKeyReleased, this);

    _eventDispatcher->addEventListenerWithSceneGraphPriority(listener, this);

    auto contactListener = EventListenerPhysicsContact::create();
    contactListener->onContactBegin = CC_CALLBACK_1(Level4::onContactBegin, this);
    contactListener->onContactSeparate = CC_CALLBACK_1(Level4::onContactSeperate, this);
...
void Level4::onKeyPressed(cocos2d::EventKeyboard::KeyCode keyCode, Event* event)
{
...
void Level4::onKeyReleased(cocos2d::EventKeyboard::KeyCode keyCode, Event* event)
{
    switch (keyCode) {
    case EventKeyboard::KeyCode::KEY_A:
        player.switchKey('a');
...
bool Level4::onContactSeperate(cocos2d::PhysicsContact& contact) {
    PhysicsBody* a = contact.getShapeA()->getBody();
    PhysicsBody* b = contact.getShapeB()->getBody();
