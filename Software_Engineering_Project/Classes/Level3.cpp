...
bool Level3::init()
{
    ...
    background = Sprite::create("res/MapTMX/Level3.png");
    ...
    auto map = TMXTiledMap::create("res/MapTMX/Level3.tmx");
    ...
    key = Sprite::create("res/PNG/Items/keyGreen.png");
    ...
    listener->onKeyPressed = CC_CALLBACK_2(Level3::onKeyPressed, this);
    listener->onKeyReleased = CC_CALLBACK_2(Level3::onKeyReleased, this);

    _eventDispatcher->addEventListenerWithSceneGraphPriority(listener, this);

    auto contactListener = EventListenerPhysicsContact::create();
    contactListener->onContactBegin = CC_CALLBACK_1(Level3::onContactBegin, this);
    contactListener->onContactSeparate = CC_CALLBACK_1(Level3::onContactSeperate, this);
...
void Level3::onKeyPressed(cocos2d::EventKeyboard::KeyCode keyCode, Event* event)
{
...
void Level3::onKeyReleased(cocos2d::EventKeyboard::KeyCode keyCode, Event* event)
{
    switch (keyCode) {
    case EventKeyboard::KeyCode::KEY_A:
        player.switchKey('a');
...
bool Level3::onContactSeperate(cocos2d::PhysicsContact& contact) {
    PhysicsBody* a = contact.getShapeA()->getBody();
    PhysicsBody* b = contact.getShapeB()->getBody();
